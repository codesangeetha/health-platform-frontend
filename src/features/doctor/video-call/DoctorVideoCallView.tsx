...
import './video-call-view.styles.css';

export const DoctorVideoCallView: React.FC = () => {
  ...
  return (
    <DoctorLayout
      ...
      pageSubtitle={`Consultation for appointment ${appointmentId}`}
      useDoctorContainer={true}
    >
      <div className="video-call-view-container">
        ...
        <div className="video-grid">
          <div className="video-container">
            ...
            />
            <div className="video-label">You (Doctor)</div>
          </div>
          <div className="video-container">
            <video 
              id="remoteVideo" 
...
export default DoctorVideoCallView;