...
import { deleteDoctor } from '../../../../services/admin/doctors.service';
...
export function DeleteDoctorDialog({ open, doctor, onClose, onDeleted }: DeleteDoctorDialogProps) {
