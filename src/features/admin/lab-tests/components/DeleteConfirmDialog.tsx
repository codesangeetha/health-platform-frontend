...
import { deleteLabTest } from '../../../../services/admin/lab-tests.service';
...
export function DeleteConfirmDialog({ open, labTest, onClose, onDeleted }: DeleteConfirmDialogProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      setDeleting(true);
      setError(null);
      await deleteLabTest(labTest.testId);
      onDeleted();
    } catch (err: any) {
    ...
    <Backdrop open={open}>
      <Dialog>
        ...
        <Content>
          ...
          <Text>
            Are you sure you want to delete "{labTest.name}"? This action cannot be undone.
          </Text>
          <Actions>
