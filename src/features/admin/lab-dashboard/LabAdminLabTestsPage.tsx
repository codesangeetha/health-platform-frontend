...
import { LabTestList } from '../lab-tests/LabTestList';
...
export const LabAdminLabTestsPage = () => {
    ...
    <AppLayout>
      ...
      <MainContainer>
        ...
        <PageContainer>
          ...
          <LabTestList refreshKey={refreshToken} categories={categories} filters={filters} showActions={false} />
        </PageContainer>
        <Footer />
      </MainContainer>
    </AppLayout>
