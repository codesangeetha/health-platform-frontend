  ...
  return (
    <AppLayout>
      ...
      <MainContainer>
        ...
        <ActionBar>
          <div />
          <CreateButton onClick={() => setOpen(true)}>+ Create Specialization</CreateButton>
        </ActionBar>
        <SpecializationsList refreshKey={refreshToken} />
        <CreateSpecializationModal open={open} onClose={() => setOpen(false)} onCreated={handleCreated} />
        <Footer />
      </MainContainer>
    </AppLayout>
  );
