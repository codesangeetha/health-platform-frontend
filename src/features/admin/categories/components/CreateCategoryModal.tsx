...
export function CreateCategoryModal({ open, onClose, onCreated }: { open: boolean; onClose: () => void; onCreated: () => void; }) {
    ...
    const validateName = (v: string) => {
        ...
        if (s.length < 2) return 'Category name must be at least 2 characters.';
        if (s.length > 50) return 'Category name cannot exceed 50 characters.';
        return undefined;
    };
                        ...
                        <InputRow>
                            <Label>
                                ...
                                <TextArea
                                    ...
                                    onBlur={handleBlur}
                                    name="description"
                                    placeholder="Essential vitamins and dietary supplements for daily health..."
                                />
